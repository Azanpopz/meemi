...
➢ 𝖢𝗅𝗂𝖼𝗄 <b>𝖧𝖾𝗅𝗉</b> 𝗍𝗈 𝗆𝗒 𝖥𝗎𝗇𝖼𝗍𝗂𝗈𝗇𝗌<a href='https://telegra.ph/file/2ab4bd4309fc808516bfa.jpg'>.</a>"""
    ...
    STARTS_TXT = """𝐇𝐞𝐥𝐥𝐨 {},
𝐅𝐨𝐫𝐰𝐞𝐫𝐝 𝐓𝐡𝐢𝐬 𝐅𝐢𝐥𝐞 𝐘𝐨𝐮𝐫 𝐒𝐚𝐯𝐞𝐂𝐥𝐨𝐮𝐝.."""
...
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Kolkata</code></b>"""
    ...
    ALERT_TXT = """ {query.message.from_user.mention} ᴛʜɪꜱ ɪꜱ ɴᴏᴛ ꜰᴏʀ ʏᴏʏ ꜱɪʀ"""
...
📮𝐔𝐬𝐞𝐫 𝐍𝐚𝐦𝐞: {mention}
🏷️𝐌𝐲 𝐍𝐚𝐦𝐞:{}
📤 ✮ 𝐉𝐨𝐢𝐧 𝐍𝐨𝐰 » <a [Click Here](http://t.me/nasrani_update) </a>
╰────── • ◆ • ──────╯
  ♡ ㅤ  ❍ㅤ     ⎙     ⌲
...
╰━━━━━━━━━━━━━━━➣ """
    ...
    SPELL_TXT = """𝐇𝐞𝐥𝐥𝐨 {} Sᴘᴇʟʟɪɴɢ Mɪꜱᴛᴀᴋᴇ Bʀᴏ ‼️ ᴅᴏɴ'ᴛ ᴡᴏʀʀʏ 😊 Cʜᴏᴏꜱᴇ ᴛʜᴇ ᴄᴏʀʀᴇᴄᴛ ᴏɴᴇ ʙᴇʟᴏᴡ 👇"""
