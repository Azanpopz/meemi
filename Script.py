...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @nasrani_update"""
    JSON_TXT = """<b>JSON:</b>
...
<b>ꜰɪʟᴇꜱ ʜᴇʀᴇ ɢᴇᴛꜱ ᴅᴇʟᴇᴛᴇᴅ ᴡɪᴛʜ ɪɴ 5 ᴍɪɴᴜᴛᴇꜱ \n\nᴘʟᴇᴀꜱᴇ ᴄʟɪᴄᴋ ᴛʜᴇ ᴍɪᴅᴅʟᴇ ʙᴜᴛᴛᴏɴ ᴀɴᴅ ᴊᴏɪɴ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ᴍᴏᴠɪᴇ.</b>
"""
    CHANNEL_CAP = """
<b>𝐇𝐞𝐲 👋{}</b> 😍\n

📂 Mᴏᴠɪᴇ Nᴀᴍᴇ :<code>{}</code>\n

⚙️ Mᴏᴠɪᴇ Sɪᴢᴇ: {size}  \n

<b>⚙️ Fɪʟᴇ Sɪᴢᴇ</b> : <b>{}</b>

⚠️ <b>FILES FORWARD TO YOUR SAVED MESSAGES\n\n\nAll files here Gets Deleted With in 5 Minutes\n╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╗\n\n♻️ 𝙅𝙊𝙄𝙉 :- @nasrani_update\n♻️ 𝙅𝙊𝙄𝙉 :- @NasraniSeries\n╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ═════╝</b> \n

⚠️ <b> കോപ്പി റൈറ്റ് ഉള്ളത് കൊണ്ട് ഈ ഒരു ഫയൽ 5 മിനിറ്റ് കൊണ്ട് ഇവിടെ നിന്നും ഡിലേറ്റാവും...!!! അതുകൊണ്ട് ഇവിടെ നിന്നും മറ്റെവിടെക്കെങ്കിലും മാറ്റിയതിന് ശേഷം ഡൗൺലോഡ് ചെയ്യുക!</b>
...
🌟 𝐑𝐚𝐭𝐢𝐧𝐠 : <a {url}/ratings>{rating}</a> / 10
