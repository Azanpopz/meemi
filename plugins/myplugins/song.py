...
@Client.on_message(filters.command(["music", "mp3"]) & ~filters.channel & ~filters.edited)
def a(client, message):
    ...
    try:
        ...
        m.edit('**An Error Occured. Please Report This To** @nasrani_update !!')
        print(e)
    try:
...
@Client.on_message(filters.command(["ytvideo", "videos", "ytdl"]))
