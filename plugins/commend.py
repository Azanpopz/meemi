...
@Client.on_message(filters.command("starts") & filters.incoming)
...
@Client.on_message(filters.command('dlete') & filters.user(ADMINS))
...
@Client.on_message(filters.command('dleteall') & filters.user(ADMINS))
...
@Client.on_callback_query(filters.regex(r'^autofilter_dlete'))
...
@Client.on_message((filters.command(["requests", "Request"]) | filters.regex("#request") | filters.regex("#Request")) & filters.group)
...
@Client.on_message(filters.command("sends") & filters.user(ADMINS))
...
@Client.on_message(filters.command("dletefiles") & filters.user(ADMINS))
...
@Client.on_message(filters.command("shortlinks") & filters.user(ADMINS))
